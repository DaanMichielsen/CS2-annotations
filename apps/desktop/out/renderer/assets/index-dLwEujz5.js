...
const __vite_glob_0_0 = "" + new URL("decoy-DgxQtlRv.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("flash-Db21WUXh.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("hegrenade-KB6gCqMA.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("molotov-Djj7tDl9.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("smoke-DsobyC9W.png", import.meta.url).href;
...
function buildSelectedGroups(selectedKeys, nodes, groups) {
  const result = [];
...
function groupMatchesExisting(group, existingGroups, existingNodes) {
  if (group.type === "grenade") {
    const main = group.nodes.find((n2) => n2.SubType === "main" || !n2.SubType);
    const aim = group.nodes.find((n2) => n2.SubType === "aim_target");
    const dest = group.nodes.find((n2) => n2.SubType === "destination");
    return existingGroups.grenadeGroups.some((eg2) => {
      const eNodes = eg2.indices.map((i) => existingNodes[i]);
      const eMain = eNodes.find((n2) => n2.SubType === "main" || !n2.SubType);
      const eAim = eNodes.find((n2) => n2.SubType === "aim_target");
      const eDest = eNodes.find((n2) => n2.SubType === "destination");
      return posEq(main?.Position, eMain?.Position) && posEq(main?.Angles, eMain?.Angles) && posEq(aim?.Position, eAim?.Position) && posEq(aim?.Angles, eAim?.Angles) && posEq(dest?.Position, eDest?.Position);
    });
  }
  if (group.type === "line") {
    const inWaypoints = group.nodes.map((n2) => n2.Position);
    return existingGroups.lineGroups.some((eg2) => {
      const eNodes = eg2.indices.map((i) => existingNodes[i]);
      const eWaypoints = eNodes.map((n2) => n2.Position);
  ...
  const bucket = group.type === "position" ? existingGroups.positionIndices : group.type === "text" ? existingGroups.textIndices : existingGroups.spotIndices;
  return bucket.some((i) => {
    const en = existingNodes[i];
    return posEq(inNode.Position, en.Position) && posEq(inNode.Angles, en.Angles);
  });
}
function classifyDuplicates(incoming, existingNodes) {
...
function CopyToFileModal({
  ...
  const [loadingGuides, setLoadingGuides] = reactExports.useState(true);
  const [selectedFilePath, setSelectedFilePath] = reactExports.useState(null);
  const [createMode, setCreateMode] = reactExports.useState(false);
  const [newName, setNewName] = reactExports.useState("");
  const [targetNodes, setTargetNodes] = reactExports.useState(null);
  const [busy, setBusy] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    async function load() {
      ...
      const candidates = list.filter(
        (g) => g.source === "local" && g.installed && g.path !== currentFilePath && g.mapName === currentMapName
      );
      const opts = [];
  ...
  const { toAdd, skipped } = targetNodes !== null && !createMode ? classifyDuplicates(selectedGroups, targetNodes) : { toAdd: selectedGroups, skipped: [] };
  const nodesToWrite = toAdd.flatMap((g) => g.nodes);
  const allDuplicates = toAdd.length === 0 && selectedGroups.length > 0;
  const canConfirm = !busy && !allDuplicates && (createMode && newName.trim().length > 0 || !createMode && selectedFilePath !== null);
  ...
  const btnSecondary2 = "px-3 py-1.5 bg-zinc-800 border border-zinc-600 hover:bg-zinc-700 rounded text-zinc-300 cursor-pointer text-sm disabled:opacity-50 disabled:cursor-not-allowed transition-colors";
  const inputCls = "w-full px-2 py-1.5 bg-zinc-800 border border-zinc-700 rounded text-zinc-200 text-sm focus:outline-none focus:border-zinc-500";
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[500] flex items-center justify-center bg-black/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-zinc-700 rounded-xl shadow-2xl w-full max-w-sm mx-4 flex flex-col overflow-hidden max-h-[90vh]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-zinc-700/60 shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-base font-semibold text-zinc-100 m-0", children: [
        "Copy ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 flex flex-col gap-4 overflow-y-auto", children: [
      loadingGuides ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-500 text-sm text-center py-2", children: "Loading…" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        guides.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[0.7rem] text-zinc-500 m-0 uppercase tracking-wider font-semibold", children: [
            "Existing files for ",
            currentMapName || "(no map name)"
          ] }),
          guides.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "label",
            {
              className: `flex items-center gap-2.5 px-3 py-2 rounded-lg border cursor-pointer transition-colors ${selectedFilePath === g.filePath && !createMode ? "border-zinc-500 bg-zinc-700/60" : "border-zinc-700 bg-zinc-800/40 hover:border-zinc-600"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-sm text-zinc-200 truncate", children: g.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-[0.65rem] shrink-0 ${g.nodeCount > 250 ? "text-amber-400" : "text-zinc-500"}`, children: [
                  g.nodeCount > 250 ? `⚠ ${g.nodeCount}` : g.nodeCount,
                  " nodes"
                ] })
              ]
            },
        ...
        guides.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-zinc-700/60" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "label",
            {
              className: `flex items-center gap-2.5 px-3 py-2 rounded-lg border cursor-pointer transition-colors ${createMode ? "border-zinc-500 bg-zinc-700/60" : "border-zinc-700 bg-zinc-800/40 hover:border-zinc-600"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-zinc-200", children: "+ Create new file for this map" })
              ]
            }
          ),
          createMode && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pl-2 flex flex-col gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[0.65rem] text-zinc-600 m-0", children: [
              "Map: ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-500", children: currentMapName || "(none)" }),
              " · saved to annotations folder"
            ] })
          ] })
        ] }),
        (selectedFilePath !== null || createMode) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 bg-zinc-800/60 border border-zinc-700/40 rounded-lg text-xs flex flex-col gap-0.5", children: allDuplicates ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber-400", children: "All selected annotations already exist in this file." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          skipped.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-zinc-500", children: [
            skipped.length,
            " already exist and will be skipped"
          ] })
        ] }) })
      ] }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-400 text-xs m-0", children: error })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-t border-zinc-700/60 flex items-center gap-2 justify-end shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: btnSecondary2, onClick: onClose, disabled: busy, children: "Cancel" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: busy ? "Copying…" : allDuplicates ? "All duplicates" : "Copy"
        }
      )
    ] })
  ] }) });
...
const _nadeIconModules$1 = /* @__PURE__ */ Object.assign({
  "../../resources/nades/decoy.png": __vite_glob_0_0,
  "../../resources/nades/flash.png": __vite_glob_0_1,
  "../../resources/nades/hegrenade.png": __vite_glob_0_2,
  "../../resources/nades/molotov.png": __vite_glob_0_3,
  "../../resources/nades/smoke.png": __vite_glob_0_4
});
...
function GuideEditor({
  ...
  const [deleteConfirmPending, setDeleteConfirmPending] = reactExports.useState(false);
  const [showCopyModal, setShowCopyModal] = reactExports.useState(false);
  ...
  const selectedGroups = reactExports.useMemo(
  ...
  function handleDeleteSelected() {
    ...
    for (const key of selectedKeys) {
      const grenadeGroup = groups.grenadeGroups.find((g) => g.indices[0] === key);
      if (grenadeGroup) {
        grenadeGroup.indices.forEach((i) => indicesToRemove.add(i));
        continue;
      }
      const lineGroup = groups.lineGroups.find((g) => g.indices[0] === key);
      if (lineGroup) {
        lineGroup.indices.forEach((i) => indicesToRemove.add(i));
        continue;
      }
  ...
  function handleCopySuccess(message2) {
  ...
  const renderNodeRow = (i) => {
    ...
    const isEnabled = n2.Enabled !== false;
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: isEnabled ? /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOpenIcon, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(EyeClosedIcon, {})
        }
      )
    ] }, i);
  };
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          onClick: (e) => {
            e.stopPropagation();
            handleSetGroupEnabled(group.indices, !allEnabled);
          },
          children: allEnabled ? /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOpenIcon, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(EyeClosedIcon, {})
        }
      )
    ] }, group.indices.join("-"));
  };
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 min-h-0 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 min-h-0 overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: `${viewMode === "map" ? "flex-1 min-w-0" : "w-80 shrink-0"} flex flex-col border-r border-zinc-700/60`, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 h-8 flex items-center gap-2 px-2 border-b border-zinc-700/60 bg-zinc-800/40 overflow-hidden text-xs", children: selectedKeys.size > 0 && (deleteConfirmPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-red-400 shrink-0", children: [
              "Delete ",
              selectedKeys.size,
              " annotation",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-zinc-400 shrink-0", children: [
              selectedKeys.size,
              " selected"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                className: "text-zinc-500 hover:text-zinc-300 cursor-pointer bg-transparent border-none shrink-0",
                onClick: () => setSelectedKeys(/* @__PURE__ */ new Set()),
      ...
      showCopyModal && /* @__PURE__ */ jsxRuntimeExports.jsx(
        CopyToFileModal,
        {
...
function EyeOpenIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", "aria-hidden": "true", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "path",
      {
        d: "M1.5 7c0 0 2.5-4.5 5.5-4.5S12.5 7 12.5 7s-2.5 4.5-5.5 4.5S1.5 7 1.5 7z",
        stroke: "currentColor",
        strokeWidth: "1.2"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "7", cy: "7", r: "1.8", fill: "currentColor" })
  ] });
}
function EyeClosedIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", "aria-hidden": "true", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "2.5", y1: "2.5", x2: "11.5", y2: "11.5", stroke: "currentColor", strokeWidth: "1.2" })
  ] });
}
