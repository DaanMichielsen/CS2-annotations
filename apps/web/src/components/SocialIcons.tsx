...
export type PlatformDef = {
  ...
  iconSrc: string
  /** When true the icon renders at natural width (fixed height only) — for wide lockup logos like Leetify */
  iconWide?: boolean
}
...
/** Renders a platform icon. Wide logos (e.g. Leetify) get fixed height + auto width. */
