...
export default function Guides() {
  ...
  async function loadGuides() {
    ...
    try {
      ...
      setGuides(list)
      const hasAnyPath =
        (await window.electronAPI.getAnnotationsRoot()) ||
        (typeof window.electronAPI.getWorkshopContentPath === 'function' && await window.electronAPI.getWorkshopContentPath())
  ...
  async function createAndOpenGuide() {
    ...
    setCreating(true)
    setCreateError('')
    const result = await window.electronAPI.createGuide(name, newMapName.trim() || undefined)
